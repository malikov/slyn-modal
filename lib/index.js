...
module.exports.Modal = function(configuration){
    ...
    var controller = (!opts.stack && !opts.controller)? require("./base-modal-controller") : controllerContext("./"+opts.controller);
    var template = (!opts.stack && !opts.templateUrl)? require("./templates/base-modal-template.dust") : templateContext("./"+opts.templateUrl);
